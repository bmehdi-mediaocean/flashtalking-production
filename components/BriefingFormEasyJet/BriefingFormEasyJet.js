            ...
            <ul className="form-ul">
                ...
                <li className="form-li-half">
                    <div className="question-wrapper">
                        ...
                        <div className="text-xs pt-[0.375rem]">Please refer to our <a className="text-[#ff6600] font-bold" href="https://flashtalking.sharepoint.com/:f:/s/ukprod/Eiks4COFmhhDnLafgZq8eLUBkbmHSJGobHWexhYuqAhtiA?e=F7750i" target="_blank">Template Guidebooks</a> for details</div>
                    </div>
                </li>
                <li className="form-li-half">
                    <div className="question-wrapper">
